...
export function App({ drawDelayMs = 550, seed, telegraphMs = 700 }: AppProps) {
  /**
  ...
  const seats: Side[] = decreed ?? humans
  ...
  }, [match, level, seats, table, drawDelayMs, draw, telegraphMs, beat])
